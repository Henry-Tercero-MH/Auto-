            ...
            <div className="flex flex-col gap-2 w-full sm:w-auto">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border border-gray-200 bg-white text-slate-600 hover:bg-slate-50 hover:border-slate-300 font-medium text-sm transition shadow-sm min-h-[44px]"
                >
                ...
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border border-green-300 bg-green-50 text-green-700 hover:bg-green-100 hover:border-green-400 font-medium text-sm transition shadow-sm min-h-[44px]"
                >
              ...
              {/* Fila: Confirmar (ancho completo) */}
              <button
                onClick={handleSubmit}
                disabled={guardando}
                className="w-full flex items-center justify-center gap-2 bg-primary hover:bg-[#162048] text-white font-semibold px-5 py-3 rounded-xl shadow-sm hover:shadow-md transition-all duration-150 disabled:opacity-60 disabled:cursor-not-allowed min-h-[48px]"
              >
                {guardando ? (
                  <>
